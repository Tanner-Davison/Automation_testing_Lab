...
test("can search Google twice", async () => {
  // Fix the TODOs below to finish the test
    ...
    await driver.findElement(By.name("q")).sendKeys('Justin Jensen', Key.RETURN);

    await driver.findElement(By.name("q")).clear();

    await driver.findElement(By.name("q")).sendKeys('Enrique Salvador',Key.RETURN);

    // await driver.wait(until.titleIs("Enrique Salvador -Google Search"),1000);
